...
class DatabaseConnection:
    ...
    def create_user(self, user_id, username, email, password):
        insert_user_command = """
        INSERT INTO stackoverflow.users VALUES('{}', '{}', '{}', '{}');
    ...
    def create_question(self, user_id, question):
        ...
        INSERT INTO stackoverflow.questions ("userId", "question") VALUES ('{}', '{}') RETURNING "questionId"
        """.format(user_id, question)
        print(create_question_command)
    ...
    def fetch_questions_for_user(self, user_id):
        ...
        SELECT * FROM stackoverflow.questions WHERE questions.userId = '{}'
        """.format(user_id)
    ...
    def fetch_question_for_user(self, user_id, question_id):
        fetch_user_question_command = """
        SELECT * FROM stackoverflow.questions WHERE questions.userId = '{}' AND questions.questionId='{}'
    ...
    def insert_answer_for_question(self, user_id, question_id, answer):
        create_question_command = """
        INSERT INTO stackoverflow.answers (userId, questionId, answer) VALUES ('{}',{},{})
        """.format(user_id, question_id, answer)
        self.cursor.execute(create_question_command)

    def fetch_answers_for_question(self, question_id):
        fetch_answer_command = """
        SELECT * FROM stackoverflow.answers WHERE 'answers.questionId' = '{}'
        """.format(question_id)
    ...
    def delete_question(self, question_id):
        ...
        DELETE FROM stackoverflow.questions WHERE questions.questionId = '{}'
        """.format(question_id)
    ...
    def delete_answer(self, answer_id):
        ...
        DELETE FROM stackoverflow.answers WHERE answers.answerId = '{}'
        """.format(answer_id)
